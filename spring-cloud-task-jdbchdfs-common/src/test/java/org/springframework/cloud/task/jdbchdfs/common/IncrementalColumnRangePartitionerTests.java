...
@ContextConfiguration(classes = IncrementalColumnRangePartitionerTests.IncrementalColumnRangePartitionerConfiguration.class)
public class IncrementalColumnRangePartitionerTests {
	...
	@Configuration
	public static class IncrementalColumnRangePartitionerConfiguration {
